...
<body>
    <main class="table">
        ...
        <section class="table__body">
        	<form action="add_course_action.jsp" method="post">
            	<table>
        			...
        			<tr>
			        	<td></td>
			          <td><label for="course_title"><strong>course Title</strong></label></td>
        			...
        			<tr>
			          ...
			          <td><input class="input--style-4" type="number" step = .5 id="credit" name="credit" placeholder="Enter Credit" required></td>
        			</tr>
