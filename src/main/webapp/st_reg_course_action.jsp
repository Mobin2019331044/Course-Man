...
<%-- <%@ page import=" javax.servlet.http.HttpServletResponse" %> --%>
    ...
    <%
    try{
    // Retrieving parameter map from the request
    ...
    for (Map.Entry<String, String[]> entry : parameterMap.entrySet()) {
        ...
        // Processing parameter name and values
...
//         		 out.println(paramName);out.println(tem_uname);out.println(tem_id);
     	       ...
     	       // Redirecting based on the insertion result
     			if (rowsInserted>0) {
     			// Redirect the user to the student dashboard page if the user was successfully inserted
                    response.sendRedirect("studentdashboard.jsp");
     			} else {
     			// Redirect the user to the error page if the user was not inserted
