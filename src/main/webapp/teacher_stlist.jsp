...
try {
	...
	String sql = "select * from teaches,takes,registered where course_tcode = course_ccode and course_tcode=? and s_uname=username and t_uname = ? and catagory = 'student'";
